...
local config = {
    ...
    dmgPoi1 = 5, -- dgt poison entre .. et ..
    dmgPoi2 = 5,
    nb = 10 -- nb de fois que le poison touche
}
...
function SWEP:PrimaryAttack()
    ...
    if self.CooldownDelay < CurTime() then
        ...
        timer.Create("corruptionEffect/" .. math.random(0, 100000) * 10, 0.1, 10, function()
            local effectPos = plyPos + ply:GetForward() * 100 * coef
            ParticleEffect("[28]_aquadrop", effectPos, Angle(0, 0, 0))
