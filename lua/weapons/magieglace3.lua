...
function SWEP:PrimaryAttack()
	...
	timer.Create("glacepar"..own:EntIndex(),0.01,1,function()
		if self:IsValid() then
			local p = ents.Create( "info_particle_system" ) 
			p:SetKeyValue( "effect_name", "[22]_ice_ambient" )
	...
	timer.Create("glacecercle"..own:EntIndex(),0.2,1,function()
		if self:IsValid() then
			local circle = ents.Create( "glace_circle" )
...
if true then
	...
	scripted_ents.Register( ENT, "glace_circle" )
end