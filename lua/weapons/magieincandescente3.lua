...
SWEP.PrintName 		      = "Incandescente 3" 
SWEP.Author 		      = "Brounix" 
SWEP.Instructions 	      = "" 
SWEP.Contact 		      = "" 
...
function SWEP:PrimaryAttack()
	...
	if self.CooldownDelay < CurTime() then if !SERVER then return end
		...
		local nezu3 = ents.Create("nezu3")
		nezu3:SetPos(self.Owner:GetPos())
		nezu3:SetOwner(self.Owner )
		nezu3:Spawn()
...
if true then
		...
		if SERVER then
			...
			timer.Create(idx,0.01,1,function()
				if IsValid(self) then
					...
					ParticleEffectAttach( "[21]_nezuko_firetornado", 1, self, 1 )
				end
			end)
	...
	scripted_ents.Register( ENT, "nezu3" )
end