...
function SWEP:PrimaryAttack()
	...
	if self.CooldownDelay < CurTime() then if !SERVER then return end
		...
		timer.Create("feu4"..ent:EntIndex(), 0.01, 200, function ()
...
if true then
	...
	function ENT:Initialize()
		if SERVER then
			...
			par:SetKeyValue( "effect_name", "[10]_fire_tiger_projectile" )
			...
			par2:SetKeyValue( "effect_name", "[10]_fire_tiger_main" )
...
if true then
	...
	function ENT:Initialize()
		...
		local par = ents.Create( "info_particle_system" ) 
			par:SetKeyValue( "effect_name", "[10]_fire_tiger_main" )
			par:SetKeyValue( "start_active", "1" )
			par:SetParent(self)
			par:SetPos( self:GetPos() ) 
			par:SetAngles( self:GetAngles() )
	...
	scripted_ents.Register( ENT, "feu4_1" )
end