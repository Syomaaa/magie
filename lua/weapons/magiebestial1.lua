...
function SWEP:DealDamage()
	...
	if ( SERVER && IsValid( tr.Entity ) && ( tr.Entity:IsNPC() || tr.Entity:IsPlayer() || tr.Entity:Health() > 0 ) ) then
		...
		dmginfo:SetDamage( math.random( 25, 30, 35 ) )
		...
		elseif ( anim == "fists_uppercut" ) then
			...
			dmginfo:SetDamage( math.random( 40, 40, 40 ) )
		elseif ( anim == "fists_uppercut2" ) then
			...
			dmginfo:SetDamage( math.random( 45, 45 ) )
		...
		elseif ( anim == "fists_elbowstrike" ) then
			...
			dmginfo:SetDamage( math.random( 50, 50, 50 ) )
		end
