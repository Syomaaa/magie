...
function SWEP:PrimaryAttack()
	...
	if self.CooldownDelay < CurTime() then if !SERVER then return end
			...
			local poison3 = ents.Create( "poison3" )
			poison3:SetOwner( own ) 
			poison3:SetPos( pos )
			poison3:SetAngles( Angle( 0, own:GetAngles().yaw, 0 ) ) 
			poison3:Spawn() 
			poison3:Activate()
...
if true then
	...
	function ENT:Initialize()
		if SERVER then
			...
			local idx = "poisson3"..self:EntIndex()
	...
	scripted_ents.Register( ENT, "poison3" )
end